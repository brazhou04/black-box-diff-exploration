...
from safety_training.introspection_training import run_introspection_sft


def main() -> None:
    parser = argparse.ArgumentParser(description="Train a shared introspection adapter across frozen behavior LoRAs")
